    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            using(db)
            {
                ...
                Booking b1 = new Booking() { BookingId = 1, CustomerId = 1, BookingDate = new DateTime(2025,03,12), NumberOfParticipants = 1};
                
                Customer c2 = new Customer() { Name = "Mary Smith", ContactNumber = "086 546 3214" };
                Booking b2 = new Booking() { BookingId = 2, CustomerId = 2, BookingDate = new DateTime(2025, 03, 15), NumberOfParticipants = 2 };

                Customer c3 = new Customer() { Name = "Jo Doyle", ContactNumber = "087 1221 222" };
                Booking b3 = new Booking() { BookingId = 3, CustomerId = 3, BookingDate = new DateTime(2025, 03, 19), NumberOfParticipants = 3 };
